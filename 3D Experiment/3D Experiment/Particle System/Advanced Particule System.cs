...
namespace Experiment.ParticleSystem
{
    public class AdvancedParticleSystem
    {
        ...
        private AdvancedParticleSystemSettings Settings;
        ...
        private AdvancedParticleVertex[] ArrayParticles;
        ...
        public AdvancedParticleSystem(string TextureName, int MaxParticles, int NumberOfImages, BlendState BlendState, bool RotateTowardCamera, ContentManager Content, GraphicsDevice GraphicsDevice)
        {
            AdvancedParticleSystemSettings NewParticleSystemSettings = new AdvancedParticleSystemSettings(TextureName, MaxParticles, NumberOfImages, BlendState, RotateTowardCamera);
            Init(NewParticleSystemSettings, Content, GraphicsDevice);
        }

        private void Init(AdvancedParticleSystemSettings Settings, ContentManager Content, GraphicsDevice GraphicsDevice)
        {
            this.Settings = Settings;
            UseAlphaBlend = false;

            // Allocate the particle array, and fill in the corner fields (which never change).
            ArrayParticles = new AdvancedParticleVertex[Settings.MaxParticles * 4];
            ...
            Effect effect = Content.Load<Effect>("Shaders/Advanced Particle shader 3D");
            ...
            Parameters["t1"].SetValue(Settings.GetTexture(GraphicsDevice));
        ...
        public void AddParticle(Vector3 Position)
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                ArrayParticles[FirstFreeParticle * 4 + i].Seed = 0;
